...
export const labelsForAlgorithms = {
    ...
    ulcnn_deeplearning: '单传感器一维卷积深度学习模型的故障诊断',
    random_forest_machine_learning: "单传感器随机森林故障诊断",
    svc_machine_learning: "单传感器SVM的故障诊断",
    gru_deeplearning: "单传感器GRU的故障诊断",
    lstm_deeplearning: "单传感器LSTM的故障诊断",
    random_forest_multiple_machine_learning: "多传感器随机森林故障诊断",
    svc_multiple_machine_learning: "多传感器SVM的故障诊断",
    gru_multiple_deeplearning: "多传感器GRU的故障诊断",
    lstm_multiple_deeplearning: "多传感器LSTM的故障诊断",
    ulcnn_multiple_deeplearning: '多传感器一维卷积深度学习模型的故障诊断',
    spectrumModel_deeplearning: '单传感器基于时频图的深度学习模型的故障诊断',
    spectrumModel_multiple_deeplearning: '多传感器基于时频图的深度学习模型的故障诊断',
    dataSource: '数据源',
    customModule: '自定义模块',
    ...
    additional_model_one_multiple_deeplearning: '多传感器信号级加权融合的故障诊断',
    additional_model_two_multiple_deeplearning: '多传感器信号时频表征自适应加权融合的故障诊断',
    additional_model_three_multiple_deeplearning: '多传感器特征级融合的深度学习故障诊断',
